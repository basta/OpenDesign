...
- If this is the first frame being created, make sure the frontend-design skill asks the user questions to clarify the aesthetic direction before committing to it. This will inform the design of the first frame and all subsequent frames.
